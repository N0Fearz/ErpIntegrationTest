...
public class OrganizationIntegrationTests
{
    ...
    public async Task Tes1_OrganizationService_Should_Process_Keycloak_Organization_Creation_Event()
    {
        ...
        // Act
        _keycloakMockMessagePublisher.PublishMessage(testMessage, "rabbitmq", _microservicesSetup.RabbitMqContainer.GetMappedPublicPort(5672));
    ...
    public async Task Test2_ArticleService_Should_Get_Schema_For_Correct_Organization()
    {
        ...
        //Act
        var response = await client.GetAsync($"http://localhost:{_microservicesSetup.ArticleService.GetMappedPublicPort(8080)}/api/Article");
